...
export default {
  ...
  inject: ['$globals'],
  mixins: [helpers],
  components: {TableIcon, qrIcon, ocrIcon, omrIcon, cutIcon, anchorIcon, cancelIcon, readAnchorIcon, menuIcon, MoveIcon, PlayIcon, DownloadIcon, FormIcon, CheckIcon, SaveIcon},
